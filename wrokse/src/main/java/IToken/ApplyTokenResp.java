...
public class ApplyTokenResp {
	public static void main(String[] args) {
         ...
         try
         {
         PrintWriter pw = new PrintWriter(new FileOutputStream("D:\\ApplyTokenRespPr.txt"));
         pw.close();
         }
         catch(Exception e)
         {
             ...
             for (int j = 0; j < field.length; j++) { // 遍历所有属性
                 ...
                 try
                 {
                 FileWriter fw = new FileWriter(new File("D:\\ApplyTokenRespPr.txt"),true);

...
public class ReadReqQueryUserChannel {
	private static final Logger LOGGER = LoggerFactory.getLogger(GeneratorTest.class);
	public static void main(String[] args) {
		 try
	      {
	      PrintWriter pw = new PrintWriter(new FileOutputStream("D:\\ReqQueryUserChannel.txt"));
	      pw.close();
	      }
	      catch(Exception e)
	      {
	      }
		 String fileName = "D:/ReqQueryUserChannelPr.txt";  
		 readNameType(fileName);
		 readFileByLines(fileName);
		System.out.println("}");
		 try
         {
         FileWriter fw = new FileWriter(new File("D:\\ReqQueryUserChannel.txt"),true);
    ...
    public static void readNameType(String fileName) {  
        ...
        try {  
       	 String classname = "ReqQueryUserChannel";
         try
         {
         FileWriter fw = new FileWriter(new File("D:\\ReqQueryUserChannel.txt"),true);
         PrintWriter pw = new PrintWriter(fw);

...
public class ReadResRegister {
	private static final Logger LOGGER = LoggerFactory.getLogger(GeneratorTest.class);
	public static void main(String[] args) {
		 try
	      {
	      PrintWriter pw = new PrintWriter(new FileOutputStream("D:\\ResRegister.txt"));
	      pw.close();
	      }
	      catch(Exception e)
	      {
	      }
		 String fileName = "D:/ResRegisterPr.txt";  
		 readNameType(fileName);
		 readFileByLines(fileName);
		System.out.println("}");
		 try
         {
         FileWriter fw = new FileWriter(new File("D:\\ResRegister.txt"),true);
